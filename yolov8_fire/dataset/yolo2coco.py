...
parser.add_argument('--image_path', default='D:\\datasets\\images\\train',type=str, help="path of images")
parser.add_argument('--label_path', default='D:\\datasets\\labels\\train',type=str, help="path of labels .txt")
